...
table1 <- CreateTableOne(vars = c( 'sex', 'age_cat'),
                         data = test_3,
                         factorVars = c('sex', 'age_cat'  ),  
                         strata = 'ALS_stat')
table1 <- print(table1,
                printToggle = FALSE,
                noSpaces = TRUE, quote = TRUE, showAllLevels = TRUE)
table1

table2 <- CreateTableOne(vars = c( 'sex', 'age_cat'),
                         data = train_2,
                         factorVars = c('sex', 'age_cat'  ),  
                         strata = 'ALS_stat')
table2 <- print(table2,
